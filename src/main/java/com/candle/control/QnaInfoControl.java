...
public class QnaInfoControl implements Control {
	...
	public void exec(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		QnaVO qnainfo = mapper.qnaInfo(Integer.parseInt(qnaNo));
		
		req.setAttribute("qnainfo", qnainfo);
		req.getRequestDispatcher("candle/qnaInfo.tiles").forward(req, resp);
